...
<p align="center">Конвертер .py фајлова у .exe користи једноставан графички интерфејс и <a href="https://pyinstaller.readthedocs.io/en/stable/index.html">PyInstaller</a> у Python-у.</p>
...
2. Отворите cmd/терминал и у root фолдеру пројекта
...
1. Одаберите локацију ваше скрипте (налепите или користите претраживач фајлова)
   - Ивица ће постати плава ако фајл постоји
2. Изаберите остале опције и додајте ствари попут иконица или других фајлова
3. Кликните на велико плаво дугме на дну за конверзију
4. Након завршетка, пронађите ваше конвертоване фајлове у /output
...
| -c [CONFIG], --config [CONFIG]                               | опционо            | Пружа конфигурациони фајл (JSON) за попуњавање UI-а. Ово може бити генерисано у tab-у за поставке.                               |
| -o [PATH], --output-dir [PATH]                               | опционо            | Поставља подразумевани излазни директоријум. Ово може бити промењено на UI-у.                                                            |
| -bdo [FOLDER_PATH], --build-directory-override [FOLDER_PATH] | опционо            | Замењује подразумевани директоријум за изградњу. Корисно је ако желите да додате фолдер у белу листу како би спречили да антивирус брише фајлове.        |
...
Уместо да исте податке убацујете на UI изнова и изнова, можете сачувати тренутно стање одласком на секцију "Конфигурација" унутар tab-а за поставке и сачувати конфигурацију у JSON фајл. Ово може бити учитано на UI ради попуњавања свих поља.

Ова акција чувања JSON конфигурације не чува излазни директоријум аутоматски јер померање хостова може означавати различиту структуру директоријума. Ако желите да имате излазни директоријум у JSON конфигурацији, додајте директоријум у `nonPyinstallerOptions.outputDirectory` унутар JSON фајла (потребно је направити нови кључ).
...
- [Слике и други фајлови који нису .py (укључивање статичких фајлова)](./examples/3-images-and-other-non-py-files/readme.md)
...
Прочитајте [CONTRIBUTING.md](./CONTRIBUTING.md) за смернице како да допринесете пројекту. Ово описује шта радити ако имате нову функционалност, измену, побољшање превода или Сте нашли проблем на auto-py-to-exe.

## Проблеми приликом коришћења алата

Ако имате проблема са упакованим извршним фајлом, или генерално са употребом алата, препоручујемо да прочитате [пост на блогу о уобичајеним проблемима са алатом auto-py-to-exe](https://nitratine.net/blog/post/issues-when-using-auto-py-to-exe/?utm_source=auto_py_to_exe&utm_medium=readme_link&utm_campaign=auto_py_to_exe_help). Овај пост обухвата оно што је потребно знати везано за паковање Python скрипти и помаже око ствари које често пођу по злу.

Ако верујете да Сте пронашли проблем са алатом, прочитајте [секцију "Пријавити Issue" у CONTRIBUTING.md](./CONTRIBUTING.md#reporting-an-issue).

## Преводи

| Језик                                    | Преводиоци                                                                                   | Преведено                             |
| ------------------------------------------- | -------------------------------------------------------------------------------------------- | -------------------------------------- |
| Arabic (العربية)                            | [Tayeb-Ali](https://github.com/tayeb-ali)                                                    | UI                                     |
| Belarusian (Беларуская)                     | [Zmicier21](https://github.com/Zmicier21)                                                    | UI и [README](README-Belarusian.md)  |
...
| Bulgarian (Български)                       | [kbkozlev](https://github.com/kbkozlev)                                                      | UI и [README](README-Bulgarian.md)   |
| Chinese Simplified (简体中文)               | [jiangzhe11](https://github.com/jiangzhe11)                                                  | UI и [README](./README-Chinese.md)   |
...
| English                                     | -                                                                                            | UI и README                          |
| Finnish (Suomen kieli)                      | [ZapX5](https://github.com/ZapX5)                                                            | UI и [README](./README-Finnish.md)   |
...
| Hebrew (עברית)                              | [ronbentata](https://github.com/ronbentata)                                                  | UI и [README](./README-Hebrew.md)    |
| Hindi (हिन्दी)                              | [triach-rold](https://github.com/triach-rold)                                                | UI и [README](./README-Hindi.md)     |
...
| Korean (한국어)                             | [jhk1090](https://github.com/jhk1090)                                                        | UI и [README](./README-Korean.md)    |
| Persian (فارسی)                             | [DrunkLeen](https://github.com/drunkleen), [Ar.dst](https://github.com/Ar-dst)               | UI и [README](./README-Persian.md)   |
| Polish (Polski)                             | [Akuczaku](https://github.com/Akuczaku)                                                      | UI                                     |
| Russian (Русский)                           | Oleg                                                                                         | UI                                     |
| Serbian Cyrillic (Српски)                   | [Radoš Milićev](https://github.com/rammba)                                                   | UI и [README](./README-Serbian_Cyrillic.md)                                     |
| Serbian Latin (Srpski)                      | [rina](https://github.com/sweatshirts), [Radoš Milićev](https://github.com/rammba)           | UI и [README](./README-Serbian_Latin.md)                                      |
| Slovak (Slovenčina)                         | [mostypc123](https://github.com/mostypc123)                                                  | UI                                     |
| Slovenian (Slovenščina)                     | [Andrew Poženel](https://github.com/anderlli0053)                                            | UI и [README](./README-Slovenian.md) |
...
| Turkish (Türkçe)                            | [mcagriaksoy](https://github.com/mcagriaksoy)                                                | UI и [README](./README-Turkish.md)   |
...
> Желите додати превод за други језик? Почитајте [секцију "Додавање и побољшање превода" у CONTRIBUTING.md](./CONTRIBUTING.md#add-or-update-a-translation).
