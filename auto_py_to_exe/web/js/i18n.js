  ...
  ui: {
    ...
    title: {
      scriptLocation: {
        ...
        fa: 'محل فایل اسکریپت',
        sr_cyrl: 'Локација скрипте',
        sr_latn: 'Lokacija skripte',
        sk: 'Lokácia skriptu',
        sl: 'Lokacija skripte',
        ja: 'スクリプトの場所',
      ...
      oneFile: {
        ...
        ar: 'ملف',
        fa: 'فایل یکپارچه',
        sr_cyrl: 'Једна датотека',
        sr_latn: 'Jedna datoteka',
        sk: 'Jeden súbor',
        sl: 'Ena datoteka',
        ja: '1つのファイル',
      ...
      consoleWindow: {
        ...
        fa: 'پنجره خط فرمان',
        sr_cyrl: 'Конзолни прозор',
        sr_latn: 'Konzolni prozor',
        sk: 'Okno konzole',
        sl: 'Konzolno okno',
        ja: 'コンソール画面',
      ...
      additionalFiles: {
        ...
        ar: 'ملفات إضافية',
        fa: 'فایل‌های تکمیلی',
        sr_cyrl: 'Додатне датотеке',
        sr_latn: 'Dodatne datoteke',
        sk: 'Dodatočné súbory',
        sl: 'Dodatne datoteke',
        ja: '追加ファイル',
      ...
      currentCommand: {
        ...
        ar: 'الأمر الحالي',
        fa: 'دستور فعلی',
        sr_cyrl: 'Тренутна команда',
        sr_latn: 'Trenutna komanda',
        sk: 'Aktuálny príkaz',
        sl: 'Trenutni ukaz',
        ja: '現在のコマンド',
      ...
      output: {
        ...
        ar: 'المخرجات',
        fa: 'خروجی',
        sr_cyrl: 'Излаз (Output)',
        sr_latn: 'Izlaz (Output)',
        sk: 'Výstup (Output)',
        sl: 'Izhod (Output)',
        ja: '出力',
        pl: 'Wyjście',
      ...
      specificOptions: {
        ...
        sr_cyrl: `${applicationName}: Специфична подешавања`,
        sr_latn: `${applicationName}: Specifična podešavanja`,
        sk: `Špecifické nastavenia ${applicationName}`,
        sl: `${applicationName} Posebne možnosti`,
      ...
      outputDirectory: {
        ...
        ar: 'دليل المخرجات',
        fa: 'پوشه خروجی',
        sr_cyrl: 'Излазни директоријум',
        sr_latn: 'Izlazni direktorijum',
      ...
      increaseRecursionLimit: {
        ...
        sr_cyrl: 'Повећај границу рекурзије',
        sr_latn: 'Povećaj granicu rekurzije',
        sk: 'Zvýšiť limit rekurzie',
        sl: 'Povečaj omejitev rekurzije',
        ja: '再帰回数の上限を増やす',
      ...
      manuallyProvideOptions: {
        ...
        sr_cyrl: 'Ручно унеси подешавања',
        sr_latn: 'Ručno unesi podešavanja',
        sk: 'Manuálne pridať nastavenia',
        sl: 'Ročno vnesi možnosti',
        ja: '手動設定',
        pl: 'Opcje manualne',
      ...
      manualArgumentInput: {
        ...
        sr_cyrl: 'Ручни унос аргумената',
        sr_latn: 'Ručni unos argumenata',
        sk: 'Manuálny vstup argumentov',
        sl: 'Ročni vnos parametrov',
        ja: '手動指定引数',
      ...
      configuration: {
        ...
        ar: 'ترتيب',
        fa: 'پیکربندی',
        sr_cyrl: 'Конфигурација',
        sr_latn: 'Konfiguracija',
        sk: 'Konfigurácia',
        sl: 'Konfiguracija',
        ja: '構成',
        pl: 'Konfiguracja',
    ...
    button: {
      ...
      oneDirectory: {
        ...
        ar: 'دليل واحد',
        fa: 'یک فولدر',
        sr_cyrl: 'Један директоријум',
        sr_latn: 'Jedan direktorijum',
      ...
      consoleBased: {
        ...
        fa: 'مبتنی بر کنسول',
        sr_cyrl: 'Конзолна апликација',
        sr_latn: 'Konzolna aplikacija',
        sk: 'V konzole',
        sl: 'Konzolna aplikacija',
        ja: 'コンソールベース',
      ...
      windowBased: {
        ...
        sr_cyrl: 'Апликација у прозору (сакриј конзолу)',
        sr_latn: 'Aplikacija u prozoru (sakrij konzolu)',
        sk: 'Aplikáci v okne (skriť konzolu)',
        sl: 'Na podlagi okna (skrij konzolo)',
      ...
      addFiles: {
        ...
        ar: 'إضافة ملفات',
        fa: 'افزودن فایل‌ها',
        sr_cyrl: 'Додај датотеке',
        sr_latn: 'Dodaj datoteke',
        sk: 'Pridať súbory',
        sl: 'Dodaj datoteke',
        ja: 'ファイルの追加',
        pl: 'Dodaj pliki',
      ...
      addFolder: {
        ...
        ar: 'أضف مجلدًا',
        fa: 'افزودن پوشه',
        sr_cyrl: 'Додај директоријум',
        sr_latn: 'Dodaj direktorijum',
      ...
      addBlank: {
        ...
        ar: 'أضف فارغًا',
        fa: 'افزودن فضای خالی',
        sr_cyrl: 'Додај празно',
        sr_latn: 'Dodaj prazno',
        sk: 'Pridať prázdne',
        sl: 'Dodaj prazno',
        ja: '空白の追加',
        pl: 'Dodaj puste pole',
      ...
      importConfig: {
        ...
        sr_cyrl: 'Учитај конфигурацију из JSON датотеке',
        sr_latn: 'Učitaj konfiguraciju iz JSON datoteke',
        sk: 'Importovať konfiguráciu s JSON súboru',
        sl: 'Uvozi konfiguracijo iz datoteke JSON',
      ...
      exportConfig: {
        ...
        sr_cyrl: 'Сачувај конфигурацију као JSON датотеку',
        sr_latn: 'Sačuvaj konfiguraciju kao JSON datoteku',
        sk: 'Exportovať konfiguráciu do JSON súboru',
        sl: 'Izvozi konfiguracijo v datoteko JSON',
      ...
      exportScriptConfig: {
        en: 'Export Config to Script File',
        zh: '将配置导出到脚本文件',
        zh_tw: '將配置導出到腳本檔案',
        uk: 'Експортувати Конфігурацію у файл Скрипта',
        ru: 'Экспортировать Конфигурацию в Файл Скрипта',
        be: 'Экспартаваць Канфігурацыю ў файл Скрыпта',
        de: 'Konfiguration in Skript-Datei exportieren',
        pt_br: 'Exportar Config para Arquivo de Script',
        es: 'Exportar Configuración para Archivo de Script',
        es_419: 'Exportar Configuración a un archivo de Script',
        tr: 'Script Dosyasına Dışa Aktar',
        th: 'ส่งออกการตั้งค่า (ไฟล์สคริปต์)',
        fr: 'Exportation de la configuration vers un fichier script',
        he: 'ייצוא הגדרות לקובץ סקריפט',
        hi: 'निर्यात विन्यास',
        hu: 'Konfiguráció exportálása Script fájlba',
        it: 'Esporta configurazione su un file script',
        id: 'Ekspor Config ke Berkas Script',
        cs: 'Exportovat konfiguraci do skriptovacího souboru',
        el: 'Εξαγωγή ρυθμίσεων σε αρχείο script',
        ar: 'تصدير التكوين إلى ملف نصي',
        fa: 'ذخیره تنظیمات در فایل اسکریپت',
        sr_cyrl: 'Сачувај конфигурацију као скрипт датотеку',
        sr_latn: 'Sačuvaj konfiguraciju kao skript datoteku',
        ...
        vi: 'Xuất cấu hình sang tệp kịch bản',
        nl: 'Exporteer Config Naar Script Bestand',
        ko: '스크립트 파일에 구성 저장하기',
        bg: 'Експортиране на конфигурация към скриптов файл',
      },
      convert: {
        ...
        ar: 'تحويل .py إلى. exe',
        fa: 'تبدیل .py به .exe',
        sr_cyrl: 'Конвертуј .py у .exe',
        sr_latn: 'Konvertuj .py u .exe',
        sk: 'Konvertovať .py do .exe',
        sl: 'Pretvori .py v .exe',
        ja: '.pyを.exeに変換',
      ...
      openOutputFolder: {
        ...
        sr_cyrl: 'Отвори излазни директоријум',
        sr_latn: 'Otvori izlazni direktorijum',
        sk: 'Otvoriť priečinok/adresár výstupu',
        sl: 'Odpri izhodno mapo',
        ja: '出力フォルダを開く',
    ...
    placeholders: {
      pathToFile: {
        ...
        ar: 'مسار الملف',
        fa: 'مسیر فایل',
        sr_cyrl: 'Путања датотеке',
        sr_latn: 'Putanja datoteke',
        sk: 'Cesta k súboru',
        sl: 'Pot do datoteke',
        ja: 'ファイルのパス',
        pl: 'Ścieżka pliku',
      ...
      icoFile: {
        ...
        ar: 'ملف .ico',
        fa: 'فایل .ico',
        sr_cyrl: '.ico датотека',
        sr_latn: '.ico datoteka',
        sk: '.ico súbor',
        sl: 'datoteka .ico',
        ja: '.ico ファイル',
        pl: 'plik .ico',
      ...
      directory: {
        ...
        ar: 'الدليل',
        fa: 'فهرست راهنما',
        sr_cyrl: 'ДИРЕКТОРИЈУМ',
        sr_latn: 'DIREKTORIJUM',
        sk: 'PRIEČINOK',
        sl: 'IMENIK',
        ja: 'ディレクトリ',
        pl: 'KATALOG',
    ...
    helpText: {
      outputDirectory: {
        ...
        sr_cyrl: 'Директоријум за излаз. Направиће се ако не постоји.',
        sr_latn: 'Direktorijum za izlaz. Napraviće se ako ne postoji.',
        sk: 'Priečinok výstupu. Ak neexistuje, bude vytvorený',
        sl: 'Imenik, v katerega naj se shrani izhod. Ustvarjen bo, če ne obstaja',
      ...
      manualArgumentInput: {
        ...
        sr_cyrl: 'Убаци текст у генерисану команду.',
        sr_latn: 'Ubaci tekst u generisanu komandu.',
        sk: 'Manuálne pridať text do generovaného príkazu.',
        sl: 'V ustvarjeni ukaz vstavi surovo besedilo.',
    ...
    notes: {
      invalidIcoFormatWarning: {
        ...
        sr_cyrl: 'Упозорење: ова датотека није валидна .ico датотека',
        sr_latn: 'Upozorenje: ova datoteka nije validna .ico datoteka',
        sk: 'Upozornenie: súbor nie je platný .ico súbor.',
        sl: 'Opozorilo: ta datoteka ni veljavna datoteka .ico',
      ...
      oneFileAdditionalFilesNote: {
        ...
        sr_cyrl:
          'Буди опрезан када користиш додатне датотеке у режиму једне датотеке;\n' +
          `<a ${onFileModeAdditionalFilesHelpAnchorTagContents}>прочитај ово (на енглеском)</a>\n` +
          'и ажурирај свој код да би радио са PyInstaller-ом.',
        sr_latn:
          ...
          'i ažuriraj svoj kod da bi radio sa PyInstaller-om.',
        sk:
        ...
        sl:
          'Bodite previdni pri uporabi dodatnih datotek z načinom ene datoteke;\n' +
          `<a ${onFileModeAdditionalFilesHelpAnchorTagContents}>preberite to</a>\n` +
          'in posodobite svojo kodo, da bo delovala s PyInstallerjem.',
        ja:
      ...
      rootDirectory: {
        ...
        sr_cyrl: 'Ако желиш да додаш датотеке у основни (тзв. root) директоријум, додај тачку (.) у одредишту.',
        sr_latn: 'Ako želiš da dodaš datoteke u osnovni (tzv. root) direktorijum, dodaj tačku (.) u odredištu.',
        sk: 'Ak chcete přidať súbory do koreňového adresára, pridajte bodku (.) do destinácie.',
        sl: 'Če želite datoteke postaviti v korenski imenik, v cilj vstavite piko (.).',
      ...
      somethingWrongWithOutput: {
        ...
        sr_cyrl:
          'Нешто није у реду са твојим exe-ом? За могућа решења проблема, прочитај ' +
          `<a ${helpPostLinkAnchorTagContents}>овај пост о томе како да поправиш честе грешке</a>.`,
        sr_latn:
          'Nešto nije u redu sa tvojim exe-om? Za moguća rešenja problema, pročitaj ' +
        ...
        sk:
          ...
          ' pre možné riešenia.',
        sl:
          'Je kaj narobe z vašo datoteko exe? Preberite ' +
          `<a ${helpPostLinkAnchorTagContents}>to objavo o tem, kako odpraviti pogoste težave</a>` +
          ' za možne rešitve.',
        ja:
          'exeに不具合がありますか？ ' +
  ...
  dynamic: {
    title: {
      ...
      generalOptions: {
        ...
        ar: 'خيارات عامة',
        fa: 'گزینه‌های عمومی',
        sr_cyrl: 'Основна подешавања',
        sr_latn: 'Osnovna podešavanja',
      ...
      whatToBundleWhereToSearch: {
        ...
        sr_cyrl: 'Шта укључити, где га наћи',
        sr_latn: 'Šta uključiti, gde ga naći',
        sk: 'Čo pribaliť, kde hladať',
        sl: 'Kaj združiti, kje iskati',
        ja: '何を同梱するか、どこを探すか',
      ...
      howToGenerate: {
        ...
        ar: 'كيف تنشئ',
        fa: 'نحوه ی ساخت',
        sr_cyrl: 'Како генерисати',
        sr_latn: 'Kako generisati',
        sk: 'Ako generovať',
        sl: 'Kako ustvariti',
        ja: 'どのように生成するか',
        pl: 'Jak wygenerować',
      ...
      windowsAndMacOsXSpecificOptions: {
        ...
        sr_cyrl: 'Специфична подешавања за Windows и macOS X',
        sr_latn: 'Specifična podešavanja za Windows i macOS X',
        sk: 'Nastavenia špecifické fre Windows a macOS X',
        sl: 'Možnosti, specifične za Windows in macOS X',
      ...
      windowsSpecificOptions: {
        ...
        sr_cyrl: 'Специфична подешавања за Windows',
        sr_latn: 'Specifična podešavanja za Windows',
        sk: 'Nastavenia špecifické pre Windows',
        sl: 'Možnosti, specifične za Windows',
        ja: 'Windows固有の設定',
      ...
      windowsSideBySideAssemblySearchingOptions: {
        ...
        sr_cyrl: 'Windows Side-by-side Assembly подешавања претраге (напредно)',
        sr_latn: 'Windows Side-by-side Assembly podešavanja pretrage (napredno)',
        sk: 'Windows Side-by-side Assembly nastavenia hľadania (pokročilé)',
        sl: 'Nastavitve iskanja po Windows Side-by-side Assembly (napredno)',
      ...
      macOsxSpecificOptions: {
        ...
        sr_cyrl: 'Специфична подешавања за macOS X',
        sr_latn: 'Specifična podešavanja za macOS X',
        sk: 'Nastavenia špecifické pre macOS',
        sl: 'možnosti, specifične za macOS X',
        ja: 'macOS X 固有の設定',
      ...
      rarelyUsedSpecialOptions: {
        ...
        sr_cyrl: 'Ретко коришћена подешавања',
        sr_latn: 'Retko korišćena podešavanja',
        sk: 'Málo používané špecifické nastavenia',
        sl: 'Redko uporabljene posebne možnosti',
        ja: 'あまり使われない設定',
    ...
    button: {
      ...
      browseForFile: {
        ...
        fa: 'انتخاب فایل',
        sr_cyrl: 'Пронађи датотеку',
        sr_latn: 'Pronađi datoteku',
        sk: 'Hľadať súbor',
        sl: 'Prebrskaj datoteko',
        ja: 'ファイルを参照',
      ...
      browseForFolder: {
        ...
        fa: 'انتخاب پوشه',
        sr_cyrl: 'Пронађи директоријум',
        sr_latn: 'Pronađi direktorijum',
        sk: 'Hľadať priečinok',
        sl: 'Išči mapo',
        ja: 'フォルダを参照',
      ...
      converting: {
        ...
        ar: 'التحويل...',
        fa: 'در حال تبدیل...',
        sr_cyrl: 'Конвертовање...',
        sr_latn: 'Konvertovanje...',
        sk: 'Konvertuje sa...',
        sl: 'Pretvorba...',
        ja: '変換中...',
        pl: 'Konwertowanie...',
      ...
      clearOutput: {
        ...
        ar: 'مسح المخرجات',
        fa: 'پاکسازی خروجی',
        sr_cyrl: 'Очисти излаз',
        sr_latn: 'Očisti izlaz',
        sk: 'Vyčistiť výstup',
        sl: 'Počisti izhod',
        ja: '出力のクリア',
        pl: 'Wyczyść wyjście',
    ...
    modal: {
      configModalTitle: {
        ...
        sr_cyrl: 'Замени тренутну конфигурацију?',
        sr_latn: 'Zameni trenutnu konfiguraciju?',
        sk: 'Prepísať aktuálnu konfiguráciu?',
        sl: 'Preglasim trenutno konfiguracijo?',
      ...
      configModalDescription: {
        ...
        sr_cyrl: 'Све претходне вредности ће бити избрисане.',
        sr_latn: 'Sve prethodne vrednosti će biti izbrisane.',
        sk: 'Všetky aktuálne hodnoty budú vymazané.',
        sl: 'Vse prej vnesene vrednosti bodo izbrisane.',
  ...
  nonDom: {
    alert: {
      noScriptsLocationProvided: {
        ...
        sr_cyrl: 'Ниси навео локацију твоје скрипте.\nНаведи локацију на врху странице.',
        sr_latn: 'Nisi naveo lokaciju tvoje skripte.\nNavedi lokaciju na vrhu stranice.',
        sk: 'Nezadali ste lokácia skriptu.\nPridajte lokáciu skriptu na vrchu formulára.',
        sl: 'Niste navedli lokacije skript.\nProsimo, vnesite jo na vrh strani.',
      ...
      overwritePreviousOutput: {
        ...
        sr_cyrl: 'Ово ће заменити претходни излаз у излазном директоријуму.\nНастави?',
        sr_latn: 'Ovo će zameniti prethodni izlaz u izlaznom direktorijumu.\nNastavi?',
        sk: 'Toto prepíše aktuálny výstup.\nPokračovať?',
        sl: 'To dejanje bo prepisalo prejšnji izpis v izhodni mapi.\nŽelite nadaljevati?',
