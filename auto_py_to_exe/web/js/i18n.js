  ...
  ui: {
    ...
    helpText: {
      outputDirectory: {
        ...
        es_419:
          "El directorio para colocar el archivo de salida. Será creado si no existe",
      ...
      increaseRecursionLimit: {
        ...
        zh_tw:
          "啟用此功能將使用 sys.setrecursionlimit（5000）將遞歸限制設置為5000。",
        ...
        pt_br:
          "Ativar isso definirá o limite de recursão para 5000 usando sys.setrecursionlimit(5000)",
        es: "Al activar esto se definirá el límite de recursión a 5000 usando sys.setrecursionlimit(5000)",
        es_419:
          "Al activar esto se definirá el límite de recursión a 5000 usando sys.setrecursionlimit(5000)",
    ...
    notes: {
      ...
      rootDirectory: {
        ...
        pt_br:
          "Se você quiser colocar arquivos no diretório raiz, coloque um ponto (.) no destino.",
        ...
        es_419:
          "Si quiere poner los archivos en el directorio raíz, ponga un punto (.) en el destino.",
  ...
  nonDom: {
    alert: {
      noScriptsLocationProvided: {
        ...
        pt_br:
          "Você não informou a localização dos seus scripts.\nPor favor, insira isso no topo da página.",
      ...
      overwritePreviousOutput: {
        ...
        pt_br:
          "Essa ação irá sobrescrever uma saída anterior na pasta de saída.\nContinuar?",
        es: "Esta acción sobrescribirá una salida anterior en la carpeta de salida.\n¿Continuar?",
        es_419:
          "Esta acción sobrescribirá una salida anterior en la carpeta de salida.\n¿Desea continuar?",
...
const translate = (language) => {
  ...
  elementsToTranslate.forEach((element) => {
    ...
    if (
      ...
      translationBlock[language] !== undefined
    ) {
...
const getTranslation = (path) => {
  ...
  if (
    translationBlock !== undefined &&
    translationBlock[currentLanguage] !== undefined
  ) {
