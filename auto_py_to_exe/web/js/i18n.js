    ...
    ui: { // Static UI elements
        ...
        notes: {
            ...
            oneFileAdditionalFilesNote: {
                ...
                uk: 'Будьте уважні під час використання додаткових файлів в режимі onefile;' +
                ...
                es: 'Tenga cuidado al utilizar archivos adicionales con el modo de un solo archivo;\n' +
                    `<a ${onFileModeAdditionalFilesHelpAnchorTagContents}>read this</a>\n` +
                    'and update your code to work with PyInstaller.',
                es_419: 'Tenga cuidado al utilizar archivos adicionales con el modo de un solo archivo;\n' +
                    `<a ${onFileModeAdditionalFilesHelpAnchorTagContents}>read this</a>\n` +
                ...
                cs: 'Buďte opatrní když přidáváte soubory s režimem jednoho souboru;\n' +
                ...
                el: 'Να είσατε προσεκτικοί με την χρήση επιλογής ενός αρχείου\n' +
                    `<a ${onFileModeAdditionalFilesHelpAnchorTagContents}>read this</a>\n` +
                    'and update your code to work with PyInstaller.',
            ...
            somethingWrongWithOutput: {
                ...
                zh_tw: '您的 exe 有問題? 請閱讀 ' +
                    ...
                    ' 尋找可能的解決方案。',
                uk: 'Щось не так з вашим EXE? Можете з легкістю знайти відповідь' +
                ...
                id: 'Ada yang salah dengan exe Anda? Baca ' +
                    ...
                    ' yang mungkin.',
                cs: 'Něco špatně s exe souborem? Přečtěte si ' +
                    `<a ${helpPostLinkAnchorTagContents}>tento příspěvek na jak opravit běžné chyby</a>` +
                    ' pro možné řešení.',
                el: 'Πήγε κάτι στραβά με το εκτελέσιμο (exe); Διαβάστε ' +
                    `<a ${helpPostLinkAnchorTagContents}>this post on how to fix common issues</a>` +
                    ' για πιθανές λύσεις.',
