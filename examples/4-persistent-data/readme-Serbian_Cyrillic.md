...
[Овај пример](./main.py) демонстрира како можете управљати трајним подацима изван извршне датотеке. Ово је потребно када имате SQLite базу података или нешто слично што користите за чување података између различитих покретања апликације.
